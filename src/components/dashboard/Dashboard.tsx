...
export function Dashboard() {
  const { user, profile } = useAuth(); // ✅ use profile
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-4">
        ...
        <Card className="text-center">
          <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-full bg-blue-100">
            <span className="text-sm font-bold text-blue-600">BMI</span>
          </div>
          ...
          {dietPlan ? (
            <div className="space-y-4">
              <div className="rounded-lg bg-green-50 p-4">
                <p className="mb-2 font-semibold text-green-800">Today's Target: {dietPlan.total_calories} calories</p>
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-blue-50 p-4">
                ...
                <div className="space-y-1 text-sm text-blue-700">
                  {workoutPlan.exercises.slice(0, 4).map((exercise, index) => (
                    <p key={index}>
                      <strong>Day {index + 1}:</strong> {exercise.name} - {exercise.sets} sets × {exercise.reps}
                    </p>
                  ))}
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => handleGenerateWorkoutPlan('home', 5)}
                  loading={loading}
                >
                  Home Plan
                </Button>
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => handleGenerateWorkoutPlan('gym', 5)}
                  loading={loading}
                >
                  Gym Plan
                </Button>
